...
function actualizarTextoGenerado() {
    ...
    checkboxes.forEach((checkbox, index) => {
        ...
        if (checkbox.id === "generales") {
            mensajeFinalTexto = estado ? "<br>Felicitaciones por haber llegado hasta acá, y ahora a meterle con React o con lo que sigas! Abrazo!" : "<br>La entrega queda con nota final de 6, pero podés reentregar dentro de las próximas 72 horas para volver a corregirla. Abrazo!";
